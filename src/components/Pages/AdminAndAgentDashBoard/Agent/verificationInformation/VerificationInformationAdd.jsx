...
const VerificationInformationAdd = () => {
    ...
    const { data: records = [], isLoading, refetch } = useQuery({
        ...
        queryFn: async () => {
            const response = await axios.get(`${config.backendUrl}/fieldverify/get-field-verify`, apiConfig);
    ...
    return (
        <div>
            <div className="flex justify-between md:items-center flex-col md:flex-row">
                ...
                <DynamicHeader
                    mainHeader={"Add Field Verification"}
            ...
            <div className="space-y-8 p-4">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
                    <h2 className="text-xl font-bold mb-4 text-gray-800">Submitted Records</h2>
                    {isLoading ? (
...
export default VerificationInformationAdd;